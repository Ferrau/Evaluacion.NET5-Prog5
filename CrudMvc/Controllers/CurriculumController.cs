...
namespace CrudMvc.Controllers
{
    public class CurriculumController : Controller
    {
        ...
        public CurriculumController(CrudMvcContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,ReleaseDate,Genre,Price,Edad")] Curriculum curriculum)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Genre,Price, Edad")] Curriculum curriculum)
        {
            if (id != curriculum.Id)
            {
                return NotFound();
